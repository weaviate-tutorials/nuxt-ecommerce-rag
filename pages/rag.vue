<template>
    <div>
        <div class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
                            ...
                            <div class="box-wrapper">
                                ...
                                <div
                                        ...
                                        <button class="outline-none focus:outline-none"><svg
                                                class=" w-5 text-gray-600 h-5 cursor-pointer" fill="none"
            ...
            <div v-if="searchMade">
                <section class="w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right pb-8"
                                                        ...
                                                        <div class="relative bg-white pt-3">
                                                            ...
                                                            <p class="mt-2">
                                                                ...
                                                                <span class="tracking-wider text-gray-900">
                                                                   ${{ parseFloat(productResult.item1[0].properties.price.replace("₹", '')) }}</span>
                                                            </p>

                                                        </div>
                                                    </a>
                                                    <button @click="addToCart(productResult.item1[0])" class="bg-blue-300 text-white p-1">Add to Cart</button>
                                                    ...
                                                    <a href="#" class="group block overflow-hidden">
                                                        ...
                                                        <div class="relative bg-white pt-3">
                                                            ...
                                                            <p class="mt-2">
                                                                ...
                                                                <span class="tracking-wider text-gray-900">
                                                                   ${{ parseFloat(productResult.item2[0].properties.price.replace("₹", '')) }}</span>
                                                            </p>

                                                        </div>
                                                    </a>
                                                    <button @click="addToCart(productResult.item2[0])" class="bg-blue-300 text-white p-1">Add to Cart</button>
                                                    ...
                                                    <a href="#" class="group block overflow-hidden">
                                                        ...
                                                        <div class="relative bg-white pt-3">
                                                            ...
                                                            <p class="mt-2">
                                                                ...
                                                                <span class="tracking-wider text-gray-900">
                                                                   ${{ parseFloat(productResult.item3[0].properties.price.replace("₹", '')) }}</span>
                                                            </p>

                                                        </div>
                                                    </a>
                                                    <button @click="addToCart(productResult.item3[0])" class="bg-blue-300 text-white p-1">Add to Cart</button>
                                                    ...
                                                    <a href="#" class="group block overflow-hidden">
                                                        ...
                                                        <div class="relative bg-white pt-3">
                                                            ...
                                                            <p class="mt-2">
                                                                ...
                                                                <span class="tracking-wider text-gray-900">
                                                                   ${{ parseFloat(productResult.item4[0].properties.price.replace("₹", '')) }}</span>
                                                            </p>

                                                        </div>
                                                    </a>
                                                    <button @click="addToCart(productResult.item4[0])" class="bg-blue-300 text-white p-1">Add to Cart</button>
